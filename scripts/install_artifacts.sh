...
# this script will install 2g assets built on the local machine
# you will have to build 2g before running this script
#
...
cp "./$build_output/2g" "/usr/local/bin/2g"
cp "./$build_output/2g.1" "/usr/share/man/man1/2g.1"
